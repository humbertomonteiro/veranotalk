    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p>
          ...
          <strong>Verano Talk</strong> respeitar a sua privacidade em relação a
          qualquer informação sua que possamos coletar no site{" "}
          <strong>Verano Talk</strong>, e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <p>
          ...
          compensar os custos de funcionamento deste site e fornecer
        ...
        <p>
          ...
          informação que o <strong>Verano Talk</strong> oferece no site e com
        ...
        <p>
          ...
          (softwares) do <strong>Verano Talk</strong>, de seus fornecedores ou
        ...
        <p>
          Mais informaçõesEsperemos que esteja esclarecido e, como mencionado
